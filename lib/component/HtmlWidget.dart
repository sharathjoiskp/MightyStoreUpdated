...
class HtmlWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Html(
      ...
      style: {
    "strong,div,h1,h2,h3,h4,h5,h6,figure,ol,ul,strike,u,b,i,hr,header,code,data,body,big,blockquote": Style(color: appStore.textPrimaryColor, fontSize: FontSize(16)),
